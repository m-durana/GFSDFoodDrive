            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                    ...
                    <dl class="space-y-2 text-sm">
                        ...
                        @if($family->pet_information)<div><dt class="text-gray-500 dark:text-gray-400">Pets:</dt> <dd class="text-gray-900 dark:text-gray-100 mt-1">{{ $family->pet_information }}</dd></div>@endif
