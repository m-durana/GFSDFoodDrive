    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center justify-center gap-2 text-sm" id="step-indicator">
                <button type="button" onclick="goToStep(1)" class="step-dot active px-4 py-2 rounded-full bg-primary text-white font-medium transition">1. Family Info</button>
                <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                <button type="button" onclick="goToStep(2)" class="step-dot px-4 py-2 rounded-full bg-base-300 text-base-content/60 font-medium transition">2. Children</button>
                <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                <button type="button" onclick="goToStep(3)" class="step-dot px-4 py-2 rounded-full bg-base-300 text-base-content/60 font-medium transition">3. Review</button>
            </div>
            ...
            <form method="POST" action="{{ route('family.store') }}" class="space-y-6" id="family-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="preferred_language_other" id="preferred_language_other"
                                    ...
                                    class="mt-2 block w-full rounded-md border-base-300 dark:bg-gray-700 dark:text-gray-100 shadow-xs focus:border-primary focus:ring-primary sm:text-sm {{ in_array(old('preferred_language', 'English'), ['English', 'Spanish']) ? 'hidden' : '' }}"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-2 border-t border-base-300">
                                ...
                                <textarea name="severe_need_notes" id="severe_need_notes" rows="2" placeholder="Optional: describe the severe need"
                                    class="mt-2 block w-full rounded-md border-base-300 dark:bg-gray-700 dark:text-gray-100 shadow-xs focus:border-primary focus:ring-primary sm:text-sm {{ old('is_severe_need') ? '' : 'hidden' }}">{{ old('severe_need_notes') }}</textarea>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" onclick="goToStep(2)" class="inline-flex items-center px-6 py-3 bg-primary text-white rounded-md hover:opacity-90 text-sm font-medium transition">
                ...
                <div class="bg-base-100 overflow-hidden shadow-xs sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-base-content">Children Details</h3>
                        ...
                        <p id="no-children-msg" class="text-center text-base-content/50 py-8 text-sm">
                ...
                <!-- Step 2 Navigation -->
                <div class="flex items-center justify-between">
                    <button type="button" onclick="goToStep(1)" class="text-sm text-base-content/70 hover:text-gray-900 dark:hover:text-gray-200 transition">
                        &larr; Back to Family Info
                    </button>
                    <div class="flex gap-3">
                        <button type="submit" class="inline-flex items-center px-5 py-2.5 border border-base-300 text-base-content/80 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 text-sm font-medium transition">
                            Skip &amp; Save Without Children
                        </button>
                        <button type="button" onclick="goToStep(3)" class="inline-flex items-center px-6 py-3 bg-primary text-white rounded-md hover:opacity-90 text-sm font-medium transition">
                            Review &amp; Submit &rarr;
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-base-100 overflow-hidden shadow-xs sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-base-content mb-4">Review &amp; Submit</h3>
                        <div id="review-summary" class="space-y-3 text-sm text-base-content/80">
                            {{-- Populated by JS --}}
                        </div>
                    </div>
                </div>
                ...
                <!-- Step 3 Navigation -->
                <div class="flex items-center justify-between">
                    <button type="button" onclick="goToStep(2)" class="text-sm text-base-content/70 hover:text-gray-900 dark:hover:text-gray-200 transition">
    ...
    <script>
        ...
        function generateChildForms() {
            ...
            childLabels.forEach((label, i) => {
                ...
                div.className = 'child-form bg-base-200/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600';
                const inputClass = 'mt-1 block w-full rounded-md border-base-300 dark:bg-gray-700 dark:text-gray-100 shadow-xs focus:border-primary focus:ring-primary sm:text-sm';
                div.innerHTML = `
                    <h4 class="font-medium text-base-content mb-3">Child ${i + 1} <span class="text-sm font-normal text-gray-500">(${label})</span></h4>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            <label class="block text-xs text-base-content/70">Gender</label>
        ...
        function buildReview() {
            ...
            summary.innerHTML = `
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <p class="font-medium text-base-content mb-1">Family</p>
                    ...
                    <div>
                        <p class="font-medium text-base-content mb-1">Household</p>
                ...
                ${totalChildren > 0 ? `
                <div class="mt-3">
                    <p class="font-medium text-base-content mb-1">Children (${totalChildren})</p>
                    <ul class="list-disc list-inside text-base-content/70">${childrenHtml || '<li>No details entered</li>'}</ul>
