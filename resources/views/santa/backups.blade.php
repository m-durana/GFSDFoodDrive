<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    @foreach($backups as $backup)
                        ...
                        <div class="flex items-center justify-between py-3 px-4 rounded-lg mb-2 bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $backup['label'] }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                        {{ $backup['created_at']->format('g:i A') }}
                                        <span class="text-gray-400 dark:text-gray-500">&middot; {{ $backup['created_at']->diffForHumans() }}</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div>
                <a href="{{ route('santa.settings') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition">
