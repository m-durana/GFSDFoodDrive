...
<body class="bg-white dark:bg-gray-950 text-base-content antialiased">
    ...
    {{-- Hero --}}
    <section class="relative pt-32 pb-20 sm:pt-40 sm:pb-28 bg-linear-to-br from-primary via-primary/90 to-primary/80 text-white overflow-hidden">
    ...
    <section id="get-involved" class="py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @if($adoptionEnabled)
                    <a href="{{ route('adopt.index') }}" class="group block p-6 bg-base-100 border border-base-300 rounded-xl shadow-xs hover:shadow-md hover:border-primary/40 dark:hover:border-primary transition">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-lg flex items-center justify-center">
                ...
                @if($selfRegistrationEnabled)
                    <a href="{{ route('self-service.create') }}" class="group block p-6 bg-base-100 border border-base-300 rounded-xl shadow-xs hover:shadow-md hover:border-primary/40 dark:hover:border-primary transition">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center">
                ...
                <div class="group block p-6 bg-base-100 border border-base-300 rounded-xl shadow-xs">
                    <div class="flex items-start gap-4">
            ...
            @if($teamMembers->count() > 0)
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    @foreach($teamMembers as $coord)
                        <div class="bg-base-100 rounded-lg p-4 text-center shadow-xs border border-base-300">
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mt-8 flex items-center justify-center gap-4">
                    <a href="https://www.facebook.com/GFSDFoodDrive/" target="_blank" rel="noopener noreferrer"
                        class="w-10 h-10 rounded-full bg-base-200 border border-base-300 flex items-center justify-center text-gray-500 hover:text-blue-600 hover:border-blue-300 dark:hover:text-blue-400 transition" title="Facebook">
                    ...
                    <a href="https://granite.gfalls.wednet.edu/fooddrive/" target="_blank" rel="noopener noreferrer"
                        class="w-10 h-10 rounded-full bg-base-200 border border-base-300 flex items-center justify-center text-gray-500 hover:text-primary hover:border-primary/40 dark:hover:text-primary transition" title="Official Website">
