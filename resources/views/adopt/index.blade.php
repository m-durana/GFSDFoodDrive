...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 text-base-content">
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            @if(session('error'))
                <div class="bg-primary/5 dark:bg-primary/20 border border-primary/30 dark:border-primary text-primary dark:text-primary px-4 py-3 rounded-sm mb-6">
                    {{ session('error') }}
                </div>
            @endif
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach($children as $child)
                        <a href="{{ route('adopt.show', $child) }}"
                           class="block bg-base-100 rounded-lg shadow-xs border border-base-300 hover:shadow-md hover:border-primary/40 dark:hover:border-primary transition p-5">
                            <div class="flex items-start justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    @endphp
                                    <div class="shrink-0 w-10 h-10 rounded-full bg-base-200 flex items-center justify-center {{ $iconColor }}">
                                ...
                                <span class="text-xs bg-base-200 text-gray-600 dark:text-gray-300 px-2 py-1 rounded-sm font-mono">
