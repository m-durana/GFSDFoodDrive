...
<th data-sort-key="{{ $key }}" @click="sort('{{ $key }}')"
    class="px-6 py-3 text-left text-xs font-medium text-base-content/60 uppercase tracking-wider cursor-pointer select-none hover:text-gray-700 dark:hover:text-gray-200 transition {{ $class }}">
