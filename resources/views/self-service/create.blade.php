    ...
    <div class="min-h-screen bg-base-200 py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-base-content">GFSD Food Drive — Family Registration</h1>
                <p class="text-sm text-base-content/60 mt-2">Please fill out the form below to register your family for the food drive.</p>
            </div>
            ...
            <form method="POST" action="{{ route('self-service.store') }}" class="space-y-6">
                ...
                <div class="bg-base-100 overflow-hidden shadow-xs sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-base-content mb-4">School & Pets</h3>
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="pet_information" class="block text-sm font-medium text-base-content/80">Pet Information / Allergies</label>
                ...
                <div class="bg-base-100 overflow-hidden shadow-xs sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <label for="delivery_reason" class="block text-sm font-medium text-base-content/80">If family cannot have items delivered, why?</label>
                ...
                <div class="bg-base-100 overflow-hidden shadow-xs sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="severe_need" class="block text-sm font-medium text-base-content/80">Severe Need Description</label>
