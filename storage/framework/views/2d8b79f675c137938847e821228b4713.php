...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="bg-white px-4 py-3 shadow-sm" id="progress-section">
        ...
        <div class="flex items-center justify-between text-sm mb-1">
            ...
            <span class="text-gray-500" id="progress-text"><?php echo e($delivered); ?>/<?php echo e($total); ?> (<?php echo e($pct); ?>%)</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2">
            <div class="bg-green-500 h-2 rounded-full transition-all" id="progress-bar" style="width: <?php echo e($pct); ?>%"></div>
        </div>
    </div>
    ...
    <div class="px-4 py-3 space-y-3" id="stops-list">
        <?php $__currentLoopData = $route->families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="bg-white rounded-lg shadow-sm p-4 <?php echo e($isDone ? 'stop-delivered' : ''); ?>" data-stop-id="<?php echo e($family->id); ?>">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center space-x-2">
                            <span class="inline-flex items-center justify-center h-7 w-7 rounded-full text-sm font-bold stop-order
                                ...
                                <?php echo $isDone ? '&#10003;' : $family->route_order; ?>
                ...
                <div class="flex items-center space-x-2 mt-3 ml-9">
                    ...
                    <button type="button" class="deliver-btn inline-flex items-center px-3 py-1.5 bg-green-600 text-white rounded-md text-xs font-medium <?php echo e($isDone ? 'hidden' : ''); ?>"
                        onclick="markStopDelivered('<?php echo e($route->access_token); ?>', <?php echo e($family->id); ?>, this)">
    ...
    <script>
        const routeToken = <?php echo json_encode($route->access_token, 15, 512) ?>;
        const routeDataUrl = <?php echo json_encode(route('delivery.routeData', $route->access_token), 512) ?>;
        ...
        function markStopDelivered(token, familyId, btn) {
            ...
            fetch(`/delivery/route/${token}/complete/${familyId}`, {
                ...
                body: '_token=<?php echo e(csrf_token()); ?>',
                redirect: 'manual',
            })
            .then(() => {
        ...
        ?>
        let stopsData = <?php echo json_encode($stopsData, 15, 512) ?>;
        let mapMarkers = {};
