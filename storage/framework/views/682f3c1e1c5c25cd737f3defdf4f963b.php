...
<body class="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased">
    ...
    <nav class="fixed top-0 inset-x-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur border-b border-gray-200 dark:border-gray-800">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
            <?php $siteLogo = \App\Models\Setting::get('site_logo', 'logos/current-logo.png'); ?>
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="GFSD Food Drive" class="h-10 w-auto" onerror="this.style.display='none'">
            ...
            <div class="flex items-center gap-4 text-sm">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-4 py-2 bg-red-700 text-white rounded-md hover:bg-red-600 text-sm font-medium transition">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center px-4 py-2 bg-red-700 text-white rounded-md hover:bg-red-600 text-sm font-medium transition">
    ...
    <section class="relative pt-32 pb-20 sm:pt-40 sm:pb-28 bg-gradient-to-br from-red-700 via-red-800 to-red-900 text-white overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="GFSD Food Drive Logo" class="mx-auto h-28 sm:h-36 w-auto mb-6 drop-shadow-lg" onerror="this.style.display='none'">
            ...
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <?php if($adoptionEnabled): ?>
                    <a href="<?php echo e(route('adopt.index')); ?>" class="w-full sm:w-auto inline-flex justify-center items-center px-8 py-3 bg-white text-red-700 rounded-lg hover:bg-red-50 text-base font-semibold shadow-lg transition">
                        &#127873; Adopt a Tag
                    </a>
                <?php endif; ?>
                <?php if($selfRegistrationEnabled): ?>
                    <a href="<?php echo e(route('self-service.create')); ?>" class="w-full sm:w-auto inline-flex justify-center items-center px-8 py-3 bg-red-600 text-white border-2 border-white/30 rounded-lg hover:bg-red-500 text-base font-semibold transition">
    ...
    <section id="get-involved" class="py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <?php if($adoptionEnabled): ?>
                    <a href="<?php echo e(route('adopt.index')); ?>" class="group block p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md hover:border-red-300 dark:hover:border-red-700 transition">
                ...
                <?php if($selfRegistrationEnabled): ?>
                    <a href="<?php echo e(route('self-service.create')); ?>" class="group block p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md hover:border-red-300 dark:hover:border-red-700 transition">
                        <div class="flex items-start gap-4">
            ...
            <?php if(\App\Models\Setting::get('family_status_enabled', '0') === '1'): ?>
                    ...
                    <?php $__currentLoopData = $coordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 text-center shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="mx-auto w-12 h-12 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center mb-3">
                                <span class="text-red-700 dark:text-red-400 font-bold text-lg"><?php echo e(strtoupper(substr($coord->first_name, 0, 1))); ?><?php echo e(strtoupper(substr($coord->last_name, 0, 1))); ?></span>
                            </div>
                            <div class="font-medium text-sm text-gray-900 dark:text-gray-100"><?php echo e($coord->first_name); ?> <?php echo e($coord->last_name); ?></div>
                            <div class="text-xs text-red-600 dark:text-red-400 mt-0.5"><?php echo e($coord->position); ?></div>
                        </div>
        ...
        <section class="py-12 sm:py-16 bg-gray-50 dark:bg-gray-900">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-wrap items-center justify-center gap-8">
                    <?php $__currentLoopData = $sponsorLogos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="flex flex-col items-center gap-2">
                            <?php if($linkUrl): ?>
                                <a href="<?php echo e($linkUrl); ?>" target="_blank" rel="noopener noreferrer">
                            <?php endif; ?>
                            <img src="<?php echo e($imgSrc); ?>"
                                 alt="<?php echo e($sponsor['name'] ?? 'Sponsor'); ?>"
                                 class="h-16 sm:h-20 w-auto max-w-[160px] object-contain grayscale hover:grayscale-0 transition">
                            <?php if($linkUrl): ?>
                                </a>
                            <?php endif; ?>
                            <?php if(!empty($sponsor['name'])): ?>
                                <span class="text-xs text-gray-400"><?php echo e(ucwords(str_replace('-', ' ', $sponsor['name']))); ?></span>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-center sm:text-left">
                    <div class="flex items-center gap-2 justify-center sm:justify-start">
                        <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="" class="h-8 w-auto" onerror="this.outerHTML='<span class=\'text-xl\'>&#10052;</span>'">
                ...
                <div class="flex items-center gap-6 text-sm">
                    <a href="<?php echo e(route('login')); ?>" class="hover:text-white transition">Staff Login</a>
                    <?php if($adoptionEnabled): ?>
                        <a href="<?php echo e(route('adopt.index')); ?>" class="hover:text-white transition">Adopt a Tag</a>
                    <?php endif; ?>
            ...
            <div class="mt-8 pt-6 border-t border-gray-800 text-center text-xs text-gray-500">
                &copy; <?php echo e(date('Y')); ?> Granite Falls School District Food &amp; Gift Drive. All rights reserved.
...
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/welcome.blade.php ENDPATH**/ ?>