...
<body class="font-sans antialiased bg-gray-900 text-gray-100 min-h-screen flex flex-col">
    ...
    <div class="bg-gray-800 border-b border-gray-700 px-6 py-4 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('warehouse.index')); ?>" class="text-sm text-gray-400 hover:text-gray-200 transition">Exit Kiosk</a>
    </div>
        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3" id="kiosk-categories">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button data-category-id="<?php echo e($cat->id); ?>" data-category-name="<?php echo e($cat->name); ?>"
                        class="kiosk-cat-btn p-4 rounded-xl text-center transition font-medium text-sm
                            <?php echo e($cat->type === 'food' ? 'bg-amber-900/40 border border-amber-700 hover:bg-amber-900/60 text-amber-200' : ''); ?>

                            <?php echo e($cat->type === 'gift' ? 'bg-purple-900/40 border border-purple-700 hover:bg-purple-900/60 text-purple-200' : ''); ?>

                            <?php echo e($cat->type === 'baby' ? 'bg-pink-900/40 border border-pink-700 hover:bg-pink-900/60 text-pink-200' : ''); ?>

                            <?php echo e($cat->type === 'supply' ? 'bg-blue-900/40 border border-blue-700 hover:bg-blue-900/60 text-blue-200' : ''); ?>
    ...
    <script>
        ...
        let volunteerName = <?php echo json_encode(Auth::user()->name, 15, 512) ?>;
        <?php else: ?>
        ...
        function submitReceipt(categoryId, catName, barcode, itemId) {
            ...
            fetch('<?php echo e(route("warehouse.store")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/warehouse/kiosk.blade.php ENDPATH**/ ?>