     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <a href="<?php echo e(route('santa.export', array_merge(request()->query(), ['format' => 'csv']))); ?>"
                ...
                <a href="<?php echo e(route('santa.export', array_merge(request()->query(), ['format' => 'children-csv']))); ?>"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form method="GET" action="<?php echo e(route('santa.export')); ?>" class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <select name="delivery_status" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                            ...
                            <option value="in_transit" <?php echo e(request('delivery_status') === 'in_transit' ? 'selected' : ''); ?>>In Transit</option>
                            <option value="delivered" <?php echo e(request('delivery_status') === 'delivered' ? 'selected' : ''); ?>>Delivered</option>
                            <option value="picked_up" <?php echo e(request('delivery_status') === 'picked_up' ? 'selected' : ''); ?>>Picked Up</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="gift_level" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                            ...
                            <option value="0" <?php echo e(request('gift_level') === '0' ? 'selected' : ''); ?>>No Gifts</option>
                            <option value="1" <?php echo e(request('gift_level') === '1' ? 'selected' : ''); ?>>Partial</option>
                            <option value="2" <?php echo e(request('gift_level') === '2' ? 'selected' : ''); ?>>Moderate</option>
                            <option value="3" <?php echo e(request('gift_level') === '3' ? 'selected' : ''); ?>>Fully Gifted</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="assigned" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                            ...
                            <option value="1" <?php echo e(request('assigned') === '1' ? 'selected' : ''); ?>>Assigned</option>
                            <option value="0" <?php echo e(request('assigned') === '0' ? 'selected' : ''); ?>>Unassigned</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="done" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                            <option value="">All</option>
                            <option value="1" <?php echo e(request('done') === '1' ? 'selected' : ''); ?>>Complete</option>
                            <option value="0" <?php echo e(request('done') === '0' ? 'selected' : ''); ?>>Incomplete</option>
                        </select>
                    </div>
                    <div class="flex items-center space-x-3">
                        <label class="inline-flex items-center text-sm text-gray-600 dark:text-gray-300">
                            <input type="checkbox" name="needs_baby" value="1" <?php echo e(request('needs_baby') ? 'checked' : ''); ?> class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 mr-1.5">
                            Baby Supplies
                        </label>
                    </div>
                    <div class="flex items-center space-x-3">
                        <label class="inline-flex items-center text-sm text-gray-600 dark:text-gray-300">
                            <input type="checkbox" name="severe_need" value="1" <?php echo e(request('severe_need') ? 'checked' : ''); ?> class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 mr-1.5">
                            Severe Need
                        </label>
                    </div>
                    <div class="flex items-end space-x-2">
                        ...
                        <a href="<?php echo e(route('santa.export')); ?>" class="inline-flex items-center px-3 py-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-sm">
                            Clear
                        </a>
                    </div>
                </form>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Showing <?php echo e($families->count()); ?> <?php echo e(Str::plural('family', $families->count())); ?>

                        (<?php echo e($families->sum(fn($f) => $f->children->count())); ?> children)
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="<?php echo e($family->family_done ? 'bg-green-50 dark:bg-green-900/10' : ''); ?>">
                                        <td class="px-3 py-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                            <?php echo e($family->family_number ?? '-'); ?>

                                        </td>
                                        <td class="px-3 py-2 text-sm">
                                            <a href="<?php echo e(route('family.show', $family)); ?>" class="text-blue-600 dark:text-blue-400 hover:underline">
                                                <?php echo e($family->family_name); ?>

                                            </a>
                                        </td>
                                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-gray-300"><?php echo e($family->phone1); ?></td>
                                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-gray-300"><?php echo e($family->children->count()); ?></td>
                                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-gray-300"><?php echo e($family->preferred_language ?? '-'); ?></td>
                                        ...
                                        <td class="px-3 py-2 text-sm">
                                            <?php if($family->delivery_status): ?>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                    <?php echo e($family->delivery_status->value === 'delivered' || $family->delivery_status->value === 'picked_up' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : ''); ?>

                                                    <?php echo e($family->delivery_status->value === 'in_transit' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300' : ''); ?>

                                                    <?php echo e($family->delivery_status->value === 'pending' ? 'bg-gray-100 dark:bg-gray-600 text-gray-800 dark:text-gray-300' : ''); ?>

                                                "><?php echo e($family->delivery_status->label()); ?></span>
                                            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/santa/export.blade.php ENDPATH**/ ?>