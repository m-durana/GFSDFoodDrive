                            ...
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 <?php echo e($family->delivery_status?->value === 'delivered' || $family->delivery_status?->value === 'picked_up' ? 'bg-green-50 dark:bg-green-900/20' : ''); ?>">
                                <div class="flex flex-wrap items-start justify-between gap-3">
                                    ...
                                    <div class="flex flex-col space-y-2 min-w-fit">
                                        <!-- Team assignment -->
                                        <form method="POST" action="<?php echo e(route('delivery.updateTeam', $family)); ?>" class="flex items-center space-x-1">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <!-- Quick status update -->
                                        <form method="POST" action="<?php echo e(route('delivery.updateStatus', $family)); ?>" class="flex items-center space-x-1">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                        ...
                                        <!-- Add log note -->
                                        <form method="POST" action="<?php echo e(route('delivery.addLog', $family)); ?>" class="flex flex-col space-y-1">
                                            <?php echo csrf_field(); ?>
