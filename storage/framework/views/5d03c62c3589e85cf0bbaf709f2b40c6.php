...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hint','data' => ['key' => 'delivery-dispatch','text' => 'Manage deliveries in real-time. Assign drivers to auto-create optimized routes, track progress on the live map, and update delivery statuses.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['key' => 'delivery-dispatch','text' => 'Manage deliveries in real-time. Assign drivers to auto-create optimized routes, track progress on the live map, and update delivery statuses.']); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="w-full lg:w-64 shrink-0 space-y-2">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-3">
                            <div class="min-w-0">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate"><?php echo e($route->name); ?></div>
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    <?php echo e($route->driver ? $route->driver->first_name : ($route->driver_name ?? 'No driver')); ?>

                                    &middot; <?php echo e($routeDone); ?>/<?php echo e($routeTotal); ?> delivered
                                </div>
                            </div>
                            <?php if($routeTotal > 0): ?>
                                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mt-2">
                                    <div class="bg-green-500 h-1.5 rounded-full transition-all" style="width: <?php echo e(round(($routeDone/$routeTotal)*100)); ?>%"></div>
                                </div>
                            <?php endif; ?>
                            <div class="flex items-center gap-1 mt-2">
                                <a href="<?php echo e(route('delivery.driverView', $route->access_token)); ?>" target="_blank" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">Driver View</a>
                                <span class="text-gray-300 dark:text-gray-600">|</span>
                                <button type="button" onclick="navigator.clipboard.writeText('<?php echo e(url(route('delivery.driverView', $route->access_token, false))); ?>').then(() => {this.textContent='Copied!'; setTimeout(() => this.textContent='Copy Link', 1500)})"
                ...
                <div class="flex-1 space-y-4">
                        ...
                        <?php if($route->families->count() > 0): ?>
                            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-4">
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-normal text-gray-500 dark:text-gray-400"><?php echo e($route->formattedDistance()); ?> &middot; <?php echo e($route->formattedDuration()); ?></span>
                                </h4>
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $route->families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo $__env->make('delivery-day._family-card', ['family' => $family], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    ?>
                    <?php if($unroutedWithNumbers->count() > 0): ?>
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-4">
                            <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">
                                Unrouted Families
                                <span class="text-xs font-normal text-gray-500 dark:text-gray-400">(<?php echo e($unroutedWithNumbers->count()); ?>)</span>
                            </h4>
                            <div class="space-y-2">
                                <?php $__currentLoopData = $unroutedWithNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('delivery-day._family-card', ['family' => $family], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <?php if($routes->every(fn($r) => $r->families->isEmpty()) && $unroutedWithNumbers->isEmpty()): ?>
    ...
    <script>
        ...
        function submitQuickAssign() {
            ...
            const doRequest = (lat, lng) => {
                ...
                fetch('<?php echo e(route("delivery.quickAssign")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
