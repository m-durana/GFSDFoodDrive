...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hint','data' => ['key' => 'admin-settings','text' => 'Changes are saved when you click \'Save Settings\' at the bottom. Logo and sponsor uploads save immediately on submit.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['key' => 'admin-settings','text' => 'Changes are saved when you click \'Save Settings\' at the bottom. Logo and sponsor uploads save immediately on submit.']); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-1 min-w-0 space-y-6">
                    <form method="POST" action="<?php echo e(route('santa.updateSettings')); ?>" id="settings-form" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="adopt-a-tag" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="adopt_a_tag_enabled" value="1" <?php echo e($adoptATagEnabled ? 'checked' : ''); ?>

                                                class="rounded border-gray-300 dark:border-gray-600 text-red-600 shadow-sm focus:ring-red-500">
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Enable public Adopt-a-Tag portal</span>
                                        </label>
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                            Community members can browse and claim gift tags at <code><?php echo e(url('/adopt')); ?></code>
                                        </p>
                                    </div>
                                    <?php if($adoptATagEnabled): ?>
                                        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded p-3">
                                            <p class="text-sm text-green-700 dark:text-green-300">Adopt-a-Tag portal is <strong>enabled</strong>.</p>
                                            <div class="mt-2 flex items-center space-x-2">
                                                <input type="text" readonly value="<?php echo e(url('/adopt')); ?>" id="adopt-link"
                                                    class="flex-1 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm bg-gray-50 dark:bg-gray-800">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="adopt_a_tag_deadline" id="adopt_a_tag_deadline" value="<?php echo e($adoptATagDeadline); ?>"
                                    ...
                                    <div>
                                        ...
                                        <textarea name="adopt_a_tag_message" id="adopt_a_tag_message" rows="3"
                                            ...
                                            placeholder="Help make the holidays brighter for a child in Granite Falls!"><?php echo e($adoptATagMessage); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="family-status" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="family_status_enabled" value="1" <?php echo e($familyStatusEnabled ? 'checked' : ''); ?>
                        ...
                        <div id="delivery-dates" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <input type="hidden" name="delivery_schedule" id="delivery_schedule_hidden" value="<?php echo e(Setting::get('delivery_schedule', '')); ?>">
                                
                                <input type="hidden" name="delivery_dates" id="delivery_dates_hidden" value="<?php echo e($deliveryDates); ?>">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select name="delivery_return_to_role" id="delivery_return_to_role"
                                                ...
                                                <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($pos); ?>" <?php echo e($selectedRole === $pos ? 'selected' : ''); ?>><?php echo e($pos); ?></option>
                                            ...
                                            <input type="text" name="delivery_return_to" id="delivery_return_to"
                                                value="<?php echo e(Setting::get('delivery_return_to', 'System Engineers')); ?>"
                                                placeholder="System Engineers"
                                                class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm <?php echo e($selectedRole ? 'hidden' : ''); ?>"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="hs_phone_number" id="hs_phone_number"
                                                value="<?php echo e(Setting::get('hs_phone_number', '')); ?>"
                        ...
                        <div id="season" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <p class="text-sm text-gray-700 dark:text-gray-300">Current Season: <strong class="text-lg"><?php echo e($seasonYear); ?></strong></p>
                                    <input type="hidden" name="season_year" value="<?php echo e($seasonYear); ?>">
                                    <div class="flex flex-wrap gap-3">
                                        <a href="<?php echo e(route('santa.seasons.index')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 text-sm font-medium transition">Season History</a>
                                        <a href="<?php echo e(route('santa.seasons.import')); ?>" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-500 text-sm font-medium transition">Import Historical Data</a>
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">To start a new season, use <a href="<?php echo e(route('santa.seasons.index')); ?>" class="text-blue-600 hover:underline">Season History</a>.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="coordinator-positions" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <textarea name="coordinator_positions" rows="2"
                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"
                                    placeholder="System Engineer,Activities Coordinator,..."><?php echo e($coordinatorPositions); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div id="site-logo" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg scroll-mt-20 mt-6">
                            <div class="p-6">
                                ...
                                <?php $currentLogo = Setting::get('site_logo', 'logos/current-logo.png'); ?>
                                <div class="flex items-center gap-6">
                                    <img src="<?php echo e(asset('storage/' . $currentLogo)); ?>" alt="Current Logo" class="h-20 w-auto rounded border border-gray-200 dark:border-gray-700 bg-white p-2" onerror="this.style.display='none'">
                                    <div>
                        ...
                        <div id="sponsors" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg scroll-mt-20 mt-6">
                            <div class="p-6">
                                ...
                                <?php $sponsors = json_decode(Setting::get('sponsor_logos', '[]'), true) ?: []; ?>
                                <?php if(count($sponsors) > 0): ?>
                                    <div class="space-y-3 mb-4">
                                        <?php $__currentLoopData = $sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center gap-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2">
                                                <img src="<?php echo e(asset('storage/' . $sponsor['path'])); ?>" alt="<?php echo e($sponsor['name'] ?? ''); ?>" class="h-12 w-auto rounded border border-gray-200 dark:border-gray-700 bg-white p-1">
                                                <div class="flex-1 min-w-0">
                                                    <span class="block text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($sponsor['name'] ?? 'Sponsor ' . ($idx + 1)); ?></span>
                                                    <input type="url" name="sponsor_urls[<?php echo e($idx); ?>]" value="<?php echo e($sponsor['url'] ?? ''); ?>"
                                                ...
                                                <button type="submit" name="remove_sponsor" value="<?php echo e($idx); ?>"
                        ...
                        <div id="notifications" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="notifications_enabled" value="1" <?php echo e($notificationsEnabled ? 'checked' : ''); ?>
                        ...
                        <div id="sms" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="sms_enabled" value="1" <?php echo e(\App\Models\Setting::get('sms_enabled', '0') === '1' ? 'checked' : ''); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="twilio_sid" id="twilio_sid" value="<?php echo e(\App\Models\Setting::get('twilio_sid', '')); ?>"
                                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"
                                                placeholder="ACxxxxxxxx">
                                        </div>
                                        <div>
                                            <label for="twilio_token" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Auth Token</label>
                                            <input type="password" name="twilio_token" id="twilio_token" value="<?php echo e(\App\Models\Setting::get('twilio_token', '')); ?>"
                                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="twilio_from" class="block text-sm font-medium text-gray-700 dark:text-gray-300">From Number</label>
                                            <input type="text" name="twilio_from" id="twilio_from" value="<?php echo e(\App\Models\Setting::get('twilio_from', '')); ?>"
                                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="sms_on_registration" value="1" <?php echo e(\App\Models\Setting::get('sms_on_registration', '1') === '1' ? 'checked' : ''); ?>

                                                    class="rounded border-gray-300 dark:border-gray-600 text-red-600 shadow-sm focus:ring-red-500">
                                                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">A family registers</span>
                                            </label><br>
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="sms_on_gift_adopted" value="1" <?php echo e(\App\Models\Setting::get('sms_on_gift_adopted', '1') === '1' ? 'checked' : ''); ?>

                                                    class="rounded border-gray-300 dark:border-gray-600 text-red-600 shadow-sm focus:ring-red-500">
                                                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">A gift is adopted for their child</span>
                                            </label><br>
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="sms_on_in_transit" value="1" <?php echo e(\App\Models\Setting::get('sms_on_in_transit', '1') === '1' ? 'checked' : ''); ?>

                                                    class="rounded border-gray-300 dark:border-gray-600 text-red-600 shadow-sm focus:ring-red-500">
                                                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Delivery status changes to "in transit"</span>
                                            </label><br>
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="sms_on_delivered" value="1" <?php echo e(\App\Models\Setting::get('sms_on_delivered', '1') === '1' ? 'checked' : ''); ?>
                        ...
                        <div id="hints" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="hints_enabled" value="1" <?php echo e(\App\Models\Setting::get('hints_enabled', '1') === '1' ? 'checked' : ''); ?>
                        ...
                        <div id="feature-modes" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-6 scroll-mt-20">
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="use_classic_delivery" value="1" <?php echo e(\App\Models\Setting::get('use_classic_delivery', '0') === '1' ? 'checked' : ''); ?>
                                    ...
                                    <div>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="use_classic_adoption" value="1" <?php echo e(\App\Models\Setting::get('use_classic_adoption', '0') === '1' ? 'checked' : ''); ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="google_client_id" id="google_client_id" value="<?php echo e(\App\Models\Setting::get('google_client_id', '')); ?>"
                                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="google_client_secret" id="google_client_secret" value="<?php echo e(\App\Models\Setting::get('google_client_secret', '')); ?>"
                                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><strong>Callback URL:</strong> <code><?php echo e(url('/auth/google/callback')); ?></code></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="openrouteservice_key" id="openrouteservice_key"
                                        value="<?php echo e(\App\Models\Setting::get('openrouteservice_key', '')); ?>"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="bg-gray-100 dark:bg-gray-700 rounded p-3 font-mono text-xs text-gray-800 dark:text-gray-200 select-all break-all">
                                            &lt;a href="<span class="js-base-url"><?php echo e(url('/')); ?></span>/login" style="display:inline-block;padding:12px 24px;background:#b91c1c;color:#fff;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;"&gt;Staff Login&lt;/a&gt;
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Adopt-a-Tag Button</label>
                                        <div class="bg-gray-100 dark:bg-gray-700 rounded p-3 font-mono text-xs text-gray-800 dark:text-gray-200 select-all break-all">
                                            &lt;a href="<span class="js-base-url"><?php echo e(url('/')); ?></span>/adopt" style="display:inline-block;padding:12px 24px;background:#b91c1c;color:#fff;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;"&gt;Adopt a Tag&lt;/a&gt;
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Full Page Embed (iframe)</label>
                                        <div class="bg-gray-100 dark:bg-gray-700 rounded p-3 font-mono text-xs text-gray-800 dark:text-gray-200 select-all break-all">
                                            &lt;iframe src="<span class="js-base-url"><?php echo e(url('/')); ?></span>" width="100%" height="800" frameborder="0" style="border:none;"&gt;&lt;/iframe&gt;
                                        </div>
                                    </div>
                                    <p class="text-xs text-gray-400 dark:text-gray-500">
                                        These URLs reflect your current domain (<code class="js-base-url"><?php echo e(url('/')); ?></code>). In production they will automatically show your production URL.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sticky bottom-4 mt-8 flex items-center justify-between bg-white dark:bg-gray-800 shadow-lg rounded-lg px-6 py-3 border border-gray-200 dark:border-gray-700 z-10">
                            <a href="<?php echo e(route('santa.index')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition">&larr; Dashboard</a>
                    ...
                    <form id="geocode-form" method="POST" action="<?php echo e(route('santa.geocodeFamilies')); ?>" style="display:none;">
                        <?php echo csrf_field(); ?>
                    </form>
    ...
    <script>
        ...
        if (existingSchedule.length === 0 && deliveryHidden.value) {
            ...
            existingSchedule = legacyDates.map(d => ({
                date: d,
                start: '<?php echo e(\App\Models\Setting::get("delivery_time_start", "08:00")); ?>',
                end: '<?php echo e(\App\Models\Setting::get("delivery_time_end", "21:00")); ?>'
            }));
        }
