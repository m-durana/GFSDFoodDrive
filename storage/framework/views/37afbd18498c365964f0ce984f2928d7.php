...
<body class="font-sans antialiased pb-safe">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <footer class="py-4 text-center text-xs text-gray-400 dark:text-gray-600">
            <span>GFSD Food Drive &copy; <?php echo e(date('Y')); ?></span>
            <span class="mx-1">&middot;</span>
            <span>Made in 🇨🇭</span>
        </footer>
    </div>
    <?php echo $__env->make('partials.hints', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('partials.guided-tour', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
