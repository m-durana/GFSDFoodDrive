...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hint','data' => ['key' => 'coordinator-dashboard','text' => 'Print gift tags and family summaries from here. Gift tags include QR codes for adopt-a-tag tracking.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['key' => 'coordinator-dashboard','text' => 'Print gift tags and family summaries from here. Gift tags include QR codes for adopt-a-tag tracking.']); ?>
