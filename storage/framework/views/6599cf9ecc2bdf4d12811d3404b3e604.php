...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <?php if(session('created_credentials')): ?>
                <div id="credentials-banner" class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 text-blue-800 dark:text-blue-200 px-4 py-3 rounded">
                    ...
                    <div class="flex items-center space-x-3">
                        <code id="credentials-text" class="bg-blue-100 dark:bg-blue-800 px-3 py-1 rounded text-sm font-mono"><?php echo e(session('created_credentials')); ?></code>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-amber-800 dark:text-amber-200">
                                ...
                                Pending Access Requests (<?php echo e($accessRequests->count()); ?>)
                            </h3>
                        </div>

                        <div class="space-y-3">
                            <?php $__currentLoopData = $accessRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 gap-3">
                                    <div class="flex items-center gap-3">
                                        <?php if($req->avatar): ?>
                                            <img src="<?php echo e($req->avatar); ?>" alt="" class="w-10 h-10 rounded-full">
                                        <?php else: ?>
                                            <div class="w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center text-gray-500 dark:text-gray-400 text-sm font-bold">
                                                <?php echo e(strtoupper(substr($req->name, 0, 1))); ?>

                                            </div>
                                        <?php endif; ?>
                                        <div>
                                            <p class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($req->name); ?></p>
                                            <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($req->email); ?></p>
                                            <p class="text-xs text-gray-400 dark:text-gray-500">
                                                Requested: <span class="font-medium"><?php echo e($req->roleLabel()); ?></span>
                                                <?php if($req->school_source): ?> &middot; <?php echo e($req->school_source); ?> <?php endif; ?>
                                                <?php if($req->position): ?> &middot; <?php echo e($req->position); ?> <?php endif; ?>
                                                &middot; <?php echo e($req->created_at->diffForHumans()); ?>
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        <!-- Approve -->
                                        <form method="POST" action="<?php echo e(route('santa.approveAccessRequest', $req)); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="role" value="<?php echo e($req->requested_role); ?>">
                                            <button type="submit" class="inline-flex items-center px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-500 text-xs font-medium transition"
                                                    onclick="return confirm('Approve <?php echo e($req->name); ?> as <?php echo e($req->roleLabel()); ?>?')">
                                        ...
                                        <form method="POST" action="<?php echo e(route('santa.approveAccessRequest', $req)); ?>" class="inline" x-data="{ open: false }">
                                            <?php echo csrf_field(); ?>
                                            <div class="relative">
                                                ...
                                                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-1 w-40 bg-white dark:bg-gray-700 rounded-md shadow-lg border border-gray-200 dark:border-gray-600 z-10">
                                                    <?php $__currentLoopData = ['family' => 'Family', 'coordinator' => 'Coordinator']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleKey => $roleLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($roleKey !== $req->requested_role): ?>
                                                            <button type="submit" name="role" value="<?php echo e($roleKey); ?>" class="block w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600"
                                                                    onclick="return confirm('Approve as <?php echo e($roleLabel); ?>?')">
                                                                Approve as <?php echo e($roleLabel); ?>
                                        ...
                                        <!-- Deny -->
                                        <form method="POST" action="<?php echo e(route('santa.denyAccessRequest', $req)); ?>" class="inline"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="role" id="role" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    <option value="family" <?php echo e(old('role') === 'family' ? 'selected' : ''); ?>>Family Entry</option>
                                    <option value="coordinator" <?php echo e(old('role') === 'coordinator' ? 'selected' : ''); ?>>Coordinator</option>
                                    <option value="santa" <?php echo e(old('role') === 'santa' ? 'selected' : ''); ?>>Santa</option>
                                </select>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <form method="POST" action="<?php echo e(route('santa.updateUser', $u)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($u->username); ?></span>
                                            </td>
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <input type="text" name="first_name" value="<?php echo e($u->first_name); ?>"
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <input type="text" name="last_name" value="<?php echo e($u->last_name); ?>"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                            </td>
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <select name="role"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                                    <option value="inactive" <?php echo e($u->permission === 0 ? 'selected' : ''); ?>>Inactive</option>
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/santa/users.blade.php ENDPATH**/ ?>