...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <!-- Deadline banner -->
            <?php if(isset($adoptionDeadline)): ?>
                <?php $daysLeft = (int) now()->startOfDay()->diffInDays($adoptionDeadline, false); ?>
                <div class="rounded-lg shadow-sm p-4 mb-6 text-center border <?php echo e($daysLeft <= 3 ? 'bg-red-50 dark:bg-red-900/30 border-red-300 dark:border-red-700' : 'bg-amber-50 dark:bg-amber-900/20 border-amber-300 dark:border-amber-700'); ?>">
                    <p class="text-sm font-medium <?php echo e($daysLeft <= 3 ? 'text-red-700 dark:text-red-300' : 'text-amber-700 dark:text-amber-300'); ?>">
                        <?php if($daysLeft <= 0): ?>
                            Adoption deadline is <strong>today</strong>! Last chance to adopt a tag!
                        <?php elseif($daysLeft === 1): ?>
                            Only <strong>1 day</strong> left to adopt a tag! Deadline: <?php echo e($adoptionDeadline->format('F j, Y')); ?>

                        <?php else: ?>
                            <strong><?php echo e($daysLeft); ?> days</strong> left to adopt a tag. Deadline: <?php echo e($adoptionDeadline->format('F j, Y')); ?>
