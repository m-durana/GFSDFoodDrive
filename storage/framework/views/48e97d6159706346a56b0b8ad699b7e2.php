...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Edit Family: <?php echo e($family->family_name); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="<?php echo e(route('family.update', $family)); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="family_name" id="family_name" value="<?php echo e(old('family_name', $family->family_name)); ?>" required
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="address" id="address" value="<?php echo e(old('address', $family->address)); ?>" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                            </div>
                            <div>
                                ...
                                <input type="tel" name="phone1" id="phone1" value="<?php echo e(old('phone1', $family->phone1)); ?>" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                            </div>
                            <div>
                                <label for="phone2" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Secondary Phone</label>
                                <input type="tel" name="phone2" id="phone2" value="<?php echo e(old('phone2', $family->phone2)); ?>"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                            </div>
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Email</label>
                                <input type="email" name="email" id="email" value="<?php echo e(old('email', $family->email)); ?>"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                            </div>
                            <div>
                                ...
                                <select name="preferred_language" id="preferred_language"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    <option value="English" <?php echo e(old('preferred_language', $family->preferred_language) === 'English' ? 'selected' : ''); ?>>English</option>
                                    <option value="Spanish" <?php echo e(old('preferred_language', $family->preferred_language) === 'Spanish' ? 'selected' : ''); ?>>Spanish</option>
                                    <option value="Other" <?php echo e(old('preferred_language', $family->preferred_language) === 'Other' ? 'selected' : ''); ?>>Other</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div>
                                ...
                                <input type="number" name="female_adults" id="female_adults" value="<?php echo e(old('female_adults', $family->female_adults)); ?>" min="0" required
                            ...
                            <div>
                                ...
                                <input type="number" name="male_adults" id="male_adults" value="<?php echo e(old('male_adults', $family->male_adults)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                            <div>
                                <label for="other_adults" class="block text-sm text-gray-600 dark:text-gray-400">Other Adults</label>
                                <input type="number" name="other_adults" id="other_adults" value="<?php echo e(old('other_adults', $family->other_adults)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                            <div>
                                ...
                                <input type="number" name="infants" id="infants" value="<?php echo e(old('infants', $family->infants)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                            <div>
                                <label for="young_children" class="block text-sm text-gray-600 dark:text-gray-400">Young (3-7)</label>
                                <input type="number" name="young_children" id="young_children" value="<?php echo e(old('young_children', $family->young_children)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                            <div>
                                <label for="children_count" class="block text-sm text-gray-600 dark:text-gray-400">Children (8-12)</label>
                                <input type="number" name="children_count" id="children_count" value="<?php echo e(old('children_count', $family->children_count)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                            <div>
                                <label for="tweens" class="block text-sm text-gray-600 dark:text-gray-400">Tweens (13-14)</label>
                                <input type="number" name="tweens" id="tweens" value="<?php echo e(old('tweens', $family->tweens)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                            <div>
                                <label for="teenagers" class="block text-sm text-gray-600 dark:text-gray-400">Teenagers (15-17)</label>
                                <input type="number" name="teenagers" id="teenagers" value="<?php echo e(old('teenagers', $family->teenagers)); ?>" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm member-count">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-6">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="has_crhs_children" value="1" <?php echo e(old('has_crhs_children', $family->has_crhs_children) ? 'checked' : ''); ?>
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="has_gfhs_children" value="1" <?php echo e(old('has_gfhs_children', $family->has_gfhs_children) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="needs_baby_supplies" value="1" <?php echo e(old('needs_baby_supplies', $family->needs_baby_supplies) ? 'checked' : ''); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <select name="delivery_preference" id="delivery_preference"
                                    ...
                                    <option value="Delivery" <?php echo e(old('delivery_preference', $family->delivery_preference) === 'Delivery' ? 'selected' : ''); ?>>Delivery</option>
                                    <option value="Pickup" <?php echo e(old('delivery_preference', $family->delivery_preference) === 'Pickup' ? 'selected' : ''); ?>>Pickup</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="delivery_date" id="delivery_date"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    <option value="">-- Select --</option>
                                    <option value="December 18th" <?php echo e(old('delivery_date', $family->delivery_date) === 'December 18th' ? 'selected' : ''); ?>>December 18th</option>
                                    <option value="December 19th" <?php echo e(old('delivery_date', $family->delivery_date) === 'December 19th' ? 'selected' : ''); ?>>December 19th</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="delivery_time" id="delivery_time"
                                    ...
                                    <?php $__currentLoopData = ['8 am', '9 am', '10 am', '11 am', '12 pm', '1 pm', '2 pm', '3 pm', '4 pm', '5 pm']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($time); ?>" <?php echo e(old('delivery_time', $family->delivery_time) === $time ? 'selected' : ''); ?>><?php echo e($time); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="mt-4">
                            ...
                            <textarea name="delivery_reason" id="delivery_reason" rows="2"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"><?php echo e(old('delivery_reason', $family->delivery_reason)); ?></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="pet_information" id="pet_information" rows="2" placeholder="e.g. 2 dogs, 1 cat (for pet food)"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"><?php echo e(old('pet_information', $family->pet_information)); ?></textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="need_for_help" id="need_for_help" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"><?php echo e(old('need_for_help', $family->need_for_help)); ?></textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="severe_need" id="severe_need" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"><?php echo e(old('severe_need', $family->severe_need)); ?></textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="other_questions" id="other_questions" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"><?php echo e(old('other_questions', $family->other_questions)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('family.show', $family)); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition">
                        &larr; Back to Family
                    </a>
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/family/edit.blade.php ENDPATH**/ ?>