            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="<?php echo e(route('santa.families')); ?>" class="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            <h4 class="font-medium text-gray-900">All Families</h4>
                            <p class="text-sm text-gray-500 mt-1">View all registered families</p>
                        </a>
                        <a href="<?php echo e(route('santa.users')); ?>" class="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            <h4 class="font-medium text-gray-900">Manage Users</h4>
                            <p class="text-sm text-gray-500 mt-1">Add and edit system users</p>
                        </a>
                        <a href="<?php echo e(route('delivery.index')); ?>" class="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
