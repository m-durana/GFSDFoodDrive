...
<body class="text-white h-screen flex flex-col">
    ...
    <div class="flex items-center justify-between px-6 py-3 bg-gray-900 border-b border-gray-800 shrink-0">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="<?php echo e(route('santa.index')); ?>" class="text-xs text-gray-500 hover:text-gray-300">Exit</a>
        </div>
    </div>
    ...
    <script>
        const DATA_URL = <?php echo json_encode(route('santa.commandCenter.data'), 15, 512) ?>;
        let currentMode = '<?php echo e($mode === "auto" ? "delivery" : $mode); ?>';
        let map = null;
        let mapMarkers = [];
        let giftChart = null;
...
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/santa/command-center.blade.php ENDPATH**/ ?>