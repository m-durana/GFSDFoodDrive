...
<body class="font-sans text-gray-900 dark:text-gray-100 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <button onclick="toggleDarkMode()" class="mt-4 p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" title="Toggle dark mode">
...
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/layouts/guest.blade.php ENDPATH**/ ?>