        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <?php if(!empty($legacyFiles)): ?>
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                    ...
                    ?>
                    <?php if($importableYears->count() > 1): ?>
                        <div class="flex justify-end mb-3">
                            <form method="POST" action="<?php echo e(route('santa.seasons.importAllLegacy')); ?>" onsubmit="this.querySelector('button').textContent='Importing all...'; this.querySelector('button').disabled=true;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" <?php if(!$accessDriver): ?> disabled <?php endif; ?>
                                    ...
                                    Import All <?php echo e($importableYears->count()); ?> Remaining Years
                                </button>
                            </form>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $legacyFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="font-semibold text-gray-900 dark:text-gray-100">
                                        <?php echo e($year); ?> Season
                                        <?php if(in_array($year, $existingSeasons)): ?>
                                    ...
                                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between py-2 px-3 rounded bg-gray-50 dark:bg-gray-700/50">
                                            <div class="flex items-center gap-3 min-w-0">
                                                <span class="flex-shrink-0 inline-flex items-center px-2 py-0.5 rounded text-xs font-mono font-medium <?php echo e($file['ext'] === 'accdb' || $file['ext'] === 'mdb' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400' : 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400'); ?>">
                                                    .<?php echo e($file['ext']); ?>

                                                </span>
                                                <span class="text-sm text-gray-900 dark:text-gray-100 truncate" title="<?php echo e($file['name']); ?>">
                                                ...
                                                <span class="text-xs text-gray-400 flex-shrink-0"><?php echo e(number_format($file['size'] / 1024)); ?> KB</span>
                                            </div>
                                            <form method="POST" action="<?php echo e(route('santa.seasons.importLegacy')); ?>" class="flex-shrink-0 ml-3">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="legacy_path" value="<?php echo e($file['path']); ?>">
                                                <input type="hidden" name="season_year" value="<?php echo e($year); ?>">
                                                <button type="submit"
                                                    <?php if(!$accessDriver && in_array($file['ext'], ['accdb', 'mdb'])): ?> disabled <?php endif; ?>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <?php if($accessDriver): ?>
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded p-3 mb-4">
                        <p class="text-sm text-green-700 dark:text-green-300">
                            Access database support: <strong><?php echo e($accessDriver === 'odbc' ? 'ODBC driver' : 'mdbtools'); ?></strong> detected.
                        </p>
                    </div>
                <?php else: ?>
                ...
                <form method="POST" action="<?php echo e(route('santa.seasons.previewImport')); ?>" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="season_year" id="season_year" min="2000" max="2099"
                            value="<?php echo e(old('season_year', $currentYear)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(count($existingSeasons) > 0): ?>
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">Existing Seasons</h3>
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = $existingSeasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/santa/seasons/import.blade.php ENDPATH**/ ?>