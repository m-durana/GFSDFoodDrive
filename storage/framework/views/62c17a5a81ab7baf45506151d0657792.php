        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>" data-tour="nav-home" class="text-xl font-bold text-red-700 dark:text-red-400 hover:text-red-600 dark:hover:text-red-300 transition">
                        North Pole
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <?php if(auth()->user()->isFamily() || auth()->user()->isSanta()): ?>
                        <a href="<?php echo e(route('family.index')); ?>" data-tour="nav-families" class="inline-flex items-center px-1 pt-1 border-b-2 <?php echo e(request()->routeIs('family.*') ? 'border-red-400 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600'); ?> text-sm font-medium leading-5 transition duration-150 ease-in-out">
                            Families
                        </a>
                    <?php endif; ?>

                    <?php if(auth()->user()->isSanta()): ?>
                        <a href="<?php echo e(route('santa.index')); ?>" data-tour="nav-santa" class="inline-flex items-center px-1 pt-1 border-b-2 <?php echo e(request()->routeIs('santa.*') ? 'border-red-400 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600'); ?> text-sm font-medium leading-5 transition duration-150 ease-in-out">
                            Santa
                        </a>
                        <?php if(\App\Models\Setting::get('use_classic_delivery', '0') === '1'): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('delivery.index')); ?>" data-tour="nav-delivery" class="inline-flex items-center px-1 pt-1 border-b-2 <?php echo e(request()->routeIs('delivery.*') ? 'border-red-400 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600'); ?> text-sm font-medium leading-5 transition duration-150 ease-in-out">
                                Delivery Day
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->user()->isCoordinator() || auth()->user()->isSanta()): ?>
                        <a href="<?php echo e(route('coordinator.index')); ?>" data-tour="nav-coordinator" class="inline-flex items-center px-1 pt-1 border-b-2 <?php echo e(request()->routeIs('coordinator.*') ? 'border-red-400 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600'); ?> text-sm font-medium leading-5 transition duration-150 ease-in-out">
                            Coordinator
                        </a>
                        <a href="<?php echo e(route('warehouse.index')); ?>" data-tour="nav-warehouse" class="inline-flex items-center px-1 pt-1 border-b-2 <?php echo e(request()->routeIs('warehouse.*') ? 'border-red-400 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600'); ?> text-sm font-medium leading-5 transition duration-150 ease-in-out">
                            Warehouse
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <a href="<?php echo e(route('help.index')); ?>" data-tour="nav-help" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" title="Help">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <?php if(auth()->user()->isSanta()): ?>
                ...
                <?php if(\App\Models\Setting::get('use_classic_delivery', '0') === '1'): ?>
                    <a href="<?php echo e(route('coordinator.index')); ?>" class="block pl-3 pr-4 py-2 text-base font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">Delivery Sheets</a>
                <?php else: ?>
            ...
            <?php if(auth()->user()->isCoordinator() || auth()->user()->isSanta()): ?>
                ...
                <a href="<?php echo e(route('warehouse.index')); ?>" class="block pl-3 pr-4 py-2 text-base font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">Warehouse</a>
            <?php endif; ?>
        </div>
