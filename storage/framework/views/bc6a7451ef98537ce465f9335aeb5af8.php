...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="<?php echo e(route('family.store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="delivery_date" id="delivery_date"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    <option value="">-- Select --</option>
                                    <option value="December 18th" <?php echo e(old('delivery_date') === 'December 18th' ? 'selected' : ''); ?>>December 18th</option>
                                    <option value="December 19th" <?php echo e(old('delivery_date') === 'December 19th' ? 'selected' : ''); ?>>December 19th</option>
                                </select>
                            </div>
                            <div>
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/family/create.blade.php ENDPATH**/ ?>