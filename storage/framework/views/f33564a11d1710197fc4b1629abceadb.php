...
<head>
    ...
    <title>Shopping List — Family #<?php echo e($family->family_number); ?></title>
...
<body class="bg-gray-100 min-h-screen">
    <div class="max-w-lg mx-auto px-4 py-4">
        ...
        <div class="bg-red-700 text-white rounded-xl p-4 mb-4 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold">Family #<?php echo e($family->family_number); ?></h1>
                    <p class="text-red-200 text-sm"><?php echo e($family->family_name); ?> &middot; <?php echo e($family->number_of_family_members); ?> members</p>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden divide-y divide-gray-100">
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemName => $qty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="shopping-item flex items-center px-4 py-3 cursor-pointer active:bg-gray-50 transition"
                                   data-key="<?php echo e(md5($family->family_number . $itemName)); ?>"
    ...
    <script>
        const STORAGE_KEY = 'shopping_<?php echo e($family->family_number); ?>';
...
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/shopping/checklist.blade.php ENDPATH**/ ?>