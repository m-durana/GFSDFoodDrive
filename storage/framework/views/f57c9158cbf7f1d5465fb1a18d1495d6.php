        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('santa.storeSchoolRange')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        <?php echo csrf_field(); ?>
                        <div>
                                    ...
                                    <?php $__currentLoopData = $ranges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td colspan="6" class="px-0 py-0">
                                                <form method="POST" action="<?php echo e(route('santa.updateSchoolRange', $range)); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <table class="w-full">
                                                        <tr>
                                                            <td class="px-3 py-2">
                                                                <input type="text" name="school_name" value="<?php echo e($range->school_name); ?>" required
                                                                    class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                                                            </td>
                                                            <td class="px-3 py-2">
                                                                <input type="number" name="range_start" value="<?php echo e($range->range_start); ?>" required min="0"
                                                                    class="w-20 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                                                            </td>
                                                            <td class="px-3 py-2">
                                                                <input type="number" name="range_end" value="<?php echo e($range->range_end); ?>" required min="0"
                                                                    class="w-20 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm text-sm">
                                                            </td>
                                                            <td class="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">
                                                                <?php echo e($range->range_end - $range->range_start + 1); ?>

                                                            </td>
                                                            <td class="px-3 py-2">
                                                                <input type="number" name="sort_order" value="<?php echo e($range->sort_order); ?>" min="0"
                                                            ...
                                                            <td class="px-3 py-2 whitespace-nowrap">
                                                                ...
                                                                <form method="POST" action="<?php echo e(route('santa.destroySchoolRange', $range)); ?>" class="inline" onsubmit="return confirm('Remove this school range?')">
                                                                    <?php echo csrf_field(); ?>
            ...
            <div>
                <a href="<?php echo e(route('santa.numberAssignment')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition">
...
<?php endif; ?>
<?php /**PATH C:\Users\mirod\Documents\Code\JetBrains\GFSDFoodDrive\resources\views/santa/school-ranges.blade.php ENDPATH**/ ?>